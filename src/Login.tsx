      ...
      <div className=" bg-white flex">
        <section className="h-screen w-[50%] flex justify-center items-center">
          <main className="flex flex-col gap-2">
            <QrCode size={64} />
            <h1 className="font-bold text-3xl pt-4">Get Started</h1>
            ...
            <button 
            className="flex items-center justify-center gap-1 py-2 px-5 rounded-md mt-2 duration-200 text-sm bg-gradient-to-r from-[#2e1b25] to-[#684557]  text-white cursor-pointer hover:"
            >Sign Up</button>
            <p className="text-black/50 text-center">Já tem uma conta? <a href="#" className="text-[#181818] transition duration-100 hover:text-black">Entre aqui</a></p>
          </main>
