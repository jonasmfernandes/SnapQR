      ...
      <>
        {showGenerateButton && (
          <button
            ...
            className={`flex items-center gap-1 py-2 px-[71px] md:px-33 lg:px-30 rounded-md mt-2 duration-200
        ...
        {showQRCode && (
          <button
            ...
            className="flex items-center gap-1 py-2 px-[36px] lg:px-[35px] rounded-md mt-2 cursor-pointer border border-[#684557] bg-[#FFFFF2] text-[#684557] hover:bg-[#e2e2d1]"
          >
            Generate Other
          </button>
        )}
